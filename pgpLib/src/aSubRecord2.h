...
typedef struct aSubRecord {
	...
	epicsUInt32	not2;	/* Max. elements in T */
...
#define aSubRecordONVA	285
#define aSubRecordONVB	286
#define aSubRecordONVC	287
#define aSubRecordONVD	288
#define aSubRecordONVE	289
#define aSubRecordONVF	290
#define aSubRecordONVG	291
#define aSubRecordONVH	292
#define aSubRecordONVI	293
#define aSubRecordONVJ	294
#define aSubRecordONVK	295
#define aSubRecordONVL	296
#define aSubRecordONVM	297
#define aSubRecordONVN	298
#define aSubRecordONVO	299
#define aSubRecordONVP	300
#define aSubRecordONVQ	301
#define aSubRecordONVR	302
#define aSubRecordONVS	303
#define aSubRecordONVT	304
#define aSubRecordONVU	305
#endif /*INCaSubH*/
...
static int aSubRecordSizeOffset(dbRecordType *pdbRecordType)
{
  ...
  pdbRecordType->papFldDes[285]->size=sizeof(prec->onva);
  pdbRecordType->papFldDes[285]->offset=(short)((char *)&prec->onva - (char *)prec);
  pdbRecordType->papFldDes[286]->size=sizeof(prec->onvb);
  pdbRecordType->papFldDes[286]->offset=(short)((char *)&prec->onvb - (char *)prec);
  pdbRecordType->papFldDes[287]->size=sizeof(prec->onvc);
  pdbRecordType->papFldDes[287]->offset=(short)((char *)&prec->onvc - (char *)prec);
  pdbRecordType->papFldDes[288]->size=sizeof(prec->onvd);
  pdbRecordType->papFldDes[288]->offset=(short)((char *)&prec->onvd - (char *)prec);
  pdbRecordType->papFldDes[289]->size=sizeof(prec->onve);
  pdbRecordType->papFldDes[289]->offset=(short)((char *)&prec->onve - (char *)prec);
  pdbRecordType->papFldDes[290]->size=sizeof(prec->onvf);
  pdbRecordType->papFldDes[290]->offset=(short)((char *)&prec->onvf - (char *)prec);
  pdbRecordType->papFldDes[291]->size=sizeof(prec->onvg);
  pdbRecordType->papFldDes[291]->offset=(short)((char *)&prec->onvg - (char *)prec);
  pdbRecordType->papFldDes[292]->size=sizeof(prec->onvh);
  pdbRecordType->papFldDes[292]->offset=(short)((char *)&prec->onvh - (char *)prec);
  pdbRecordType->papFldDes[293]->size=sizeof(prec->onvi);
  pdbRecordType->papFldDes[293]->offset=(short)((char *)&prec->onvi - (char *)prec);
  pdbRecordType->papFldDes[294]->size=sizeof(prec->onvj);
  pdbRecordType->papFldDes[294]->offset=(short)((char *)&prec->onvj - (char *)prec);
  pdbRecordType->papFldDes[295]->size=sizeof(prec->onvk);
  pdbRecordType->papFldDes[295]->offset=(short)((char *)&prec->onvk - (char *)prec);
  pdbRecordType->papFldDes[296]->size=sizeof(prec->onvl);
  pdbRecordType->papFldDes[296]->offset=(short)((char *)&prec->onvl - (char *)prec);
  pdbRecordType->papFldDes[297]->size=sizeof(prec->onvm);
  pdbRecordType->papFldDes[297]->offset=(short)((char *)&prec->onvm - (char *)prec);
  pdbRecordType->papFldDes[298]->size=sizeof(prec->onvn);
  pdbRecordType->papFldDes[298]->offset=(short)((char *)&prec->onvn - (char *)prec);
  pdbRecordType->papFldDes[299]->size=sizeof(prec->onvo);
  pdbRecordType->papFldDes[299]->offset=(short)((char *)&prec->onvo - (char *)prec);
  pdbRecordType->papFldDes[300]->size=sizeof(prec->onvp);
  pdbRecordType->papFldDes[300]->offset=(short)((char *)&prec->onvp - (char *)prec);
  pdbRecordType->papFldDes[301]->size=sizeof(prec->onvq);
  pdbRecordType->papFldDes[301]->offset=(short)((char *)&prec->onvq - (char *)prec);
  pdbRecordType->papFldDes[302]->size=sizeof(prec->onvr);
  pdbRecordType->papFldDes[302]->offset=(short)((char *)&prec->onvr - (char *)prec);
  pdbRecordType->papFldDes[303]->size=sizeof(prec->onvs);
  pdbRecordType->papFldDes[303]->offset=(short)((char *)&prec->onvs - (char *)prec);
  pdbRecordType->papFldDes[304]->size=sizeof(prec->onvt);
  pdbRecordType->papFldDes[304]->offset=(short)((char *)&prec->onvt - (char *)prec);
  pdbRecordType->papFldDes[305]->size=sizeof(prec->onvu);
  pdbRecordType->papFldDes[305]->offset=(short)((char *)&prec->onvu - (char *)prec);
